...
mod smoke {
    use fr_core::{
        ...
        ids::{
            ...
            InputTicketId, OsSessionId, RecoveryGeneration, RemoteSessionId,
    ...
    use fr_wire::{
        ...
        negotiation::{
            Capability as NegCap, ControlBinding, Message as NegMsg, NATIVE_PROFILE,
            Offer as NegOffer, PROFILE_VERSION, Role as NegRole, decode as decode_neg,
            encode as encode_neg,
        },
        presented::{
            Report as PresReport, Sample as PresSample, Stamp as PresStamp,
            decode as decode_presented, encode as encode_presented,
        },
        receiver_metrics::{
            Load as RecvLoad, Message as RecvMsg, decode as decode_metrics,
    ...
    fn seeds_authority() -> Vec<GoldenSeed> {
        ...
        cases
            ...
            .map(|(name, m, dir)| {
                ...
                let len = fr_wire::authority::encode(
                    m,
                    auth_b,
                    &L,
                    &mut out,
    ...
    fn seeds_media() -> Vec<GoldenSeed> {
        ...
        let n3 =
            encode_repair(7, &ranges, 5, 9, &med_limits, &mut repair_out).expect("encode repair");
