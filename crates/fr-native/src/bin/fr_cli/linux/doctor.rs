...
pub(super) fn run(
    ...
    let report = output::DoctorReport {
        ...
        certificate,
        permissions: output::DoctorReport::unmeasured_permissions(),
        capabilities: output::DoctorReport::unmeasured_capabilities(),
        sessions: vec![],
        // fr doctor does not read any host's sharing or approval policy.
